...
public class GridImgAdapter3 extends BaseAdapter {
    //上下文对象
    private Context context;
    private ArrayList<TypeBean> typeBeenaArr;
    private LayoutInflater inflater;
    public GridImgAdapter3(Context context, ArrayList<TypeBean> typeBeenaArr) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (typeBeenaArr.get(position).isSHouRu()){
